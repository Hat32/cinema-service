...
{
    private static string AppTitle = "CinemaService Api";

    /// <summary>
    /// Adds and configures swaggerGen to service collection
    /// </summary>
    ...
    /// <summary>
    /// Adds and configures swagger and swaggerUI middlewares
    /// </summary>
    ...
    public static void UseAppSwagger(this WebApplication app)
    {
        ...
        app.UseSwaggerUI(
            options =>
            {
                ...
                var apiVersionDescriptionsList = provider.ApiVersionDescriptions;
                foreach(var description in apiVersionDescriptionsList.Reverse())
                {
